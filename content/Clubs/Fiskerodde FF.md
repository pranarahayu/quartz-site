...
publish: true
title: Fiskerodde FF
created: 2026-09-13T13:54:39.313+07:00
modified: 2026-09-23T16:40:45.648+07:00
---
...
<div style="text-align: center; margin-bottom: 10px;">
	<img
	src="https://kyststed.my.id/static/club/FFF.png" alt="FFF logo" style="display: block; width: 130px; height: auto; margin: 0 auto;"
	>
</div>
  ...
  <table style="width: 100%; border-collapse: collapse; background: transparent; border: none;">
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      ...
      <td style="padding: 6px 0;">Fiskerodde Fodboldforening</td>
    </tr>
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
    ...
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      ...
      <td style="padding: 6px 0;">3. Liga, 2nd of 10</td>
    </tr>
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      <td style="font-weight: bold; padding: 6px 0; vertical-align: top;">Website</td>
      <td style="padding: 6px 0;">www.fff.ks</td>
    </tr>
  </table>
<!-- Kits -->
...
<img src="https://kyststed.my.id/static/kits/FFF-home.png" alt="FFF home kit" width="75" style="display: block; height: 95px; object-fit: contain; margin: 0 auto;">
<div style="font-size: 0.8em; margin-top: 4px;">Home</div>
</div>
<div style="text-align: center;">
<img src="https://kyststed.my.id/static/kits/FFF-away.png" alt="FFF away kit" width="75" style="display: block; height: 95px; object-fit: contain; margin: 0 auto;">
<div style="font-size: 0.8em; margin-top: 4px;">Away</div>
</div>
<div style="text-align: center;">
<img src="https://kyststed.my.id/static/kits/FFF-third.png" alt="FFF third kit" width="75" style="display: block; height: 95px; object-fit: contain; margin: 0 auto;">
