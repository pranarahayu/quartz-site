...
publish: true
title: ØRK
created: 2026-09-12T11:37:21.209+07:00
modified: 2026-09-12T12:20:05.703+07:00
---
...
<div style="text-align: center; margin-bottom: 10px;">
	<img
	src="https://kyststed.my.id/static/club/ORK.png" alt="ORK logo" style="display: block; width: 130px; height: auto; margin: 0 auto;"
	>
</div>
  ...
  <table style="width: 100%; border-collapse: collapse; background: transparent; border: none;">
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      ...
      <td style="padding: 6px 0;">Østereng Boldklub Rødpil Idrætsforening Kombination</td>
    </tr>
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
    ...
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      ...
      <td style="padding: 6px 0;">Ligaen, 4th of 10</td>
    </tr>
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      <td style="font-weight: bold; padding: 6px 0; vertical-align: top;">Website</td>
      <td style="padding: 6px 0;">www.or-kombination.ks</td>
    </tr>
  </table>
  <!-- Kits -->
...
<div style="text-align: center;">
  <img
    src="https://kyststed.my.id/static/kits/ORK-home.png"
    alt="ORK home kit"
