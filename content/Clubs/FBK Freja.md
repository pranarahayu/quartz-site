...
publish: true
title: FBK Freja
created: 2026-09-20T10:50:22.894+07:00
modified: 2026-09-23T17:01:39.667+07:00
---
...
<div style="text-align: center; margin-bottom: 10px;">
	<img
	src="https://kyststed.my.id/static/club/FRJ.png" alt="FRJ logo" style="display: block; width: 130px; height: auto; margin: 0 auto;"
	>
</div>
  ...
  <table style="width: 100%; border-collapse: collapse; background: transparent; border: none;">
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      ...
      <td style="padding: 6px 0;">Fælledby Boldklubben Freja</td>
    </tr>
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
    ...
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      ...
      <td style="padding: 6px 0;">Lokalligaen Syd, 6th of 8</td>
    </tr>
    <tr style="border-bottom: 1px solid var(--background-modifier-border-hover);">
      <td style="font-weight: bold; padding: 6px 0; vertical-align: top;">Website</td>
      <td style="padding: 6px 0;">www.fbkfreja.ks</td>
    </tr>
  </table>
<!-- Kits -->
...
<img src="https://kyststed.my.id/static/kits/FBK-home.png" alt="FBK home kit" width="75" style="display: block; height: 95px; object-fit: contain; margin: 0 auto;">
<div style="font-size: 0.8em; margin-top: 4px;">Home</div>
</div>
<div style="text-align: center;">
<img src="https://kyststed.my.id/static/kits/FBK-away.png" alt="FBK away kit" width="75" style="display: block; height: 95px; object-fit: contain; margin: 0 auto;">
<div style="font-size: 0.8em; margin-top: 4px;">Away</div>
</div>
<div style="text-align: center;">
<img src="https://kyststed.my.id/static/kits/FBK-third.png" alt="FBK third kit" width="75" style="display: block; height: 95px; object-fit: contain; margin: 0 auto;">
